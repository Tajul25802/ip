...
function About() {
  ...
  echo <<<EOL
         ...
         \033[01;33mTelegram \033[01;37m:- \033[01;36Hacker
...
function upd() {
  ...
  sleep(1);
  system("cd ~/ && git clone https://github.com/Tajul25802/Ip-Tracker.git");
  system("cd ~/ && sudo git clone https://github.com/Tajul25802/Ip-Tracker.git");
